    ...
    switch (numb){
        ...
        case 2: {
            ...
            float value;
                       ...
                       cout << "Введите индекс чтобы получить значение" << endl;
                       cin >> ind;
                       Node<float>* e = getUkByInd(st, ind);
                       int x = getNodeValue(e);
                       cout << "Значение: "<<x;
